 ...
 */
export function decodeSharedItinerary(encodedStr: string): ItineraryConfig | null {
  try {
 ...
 */
export function getSharedFromUrl(): { config: ItineraryConfig; isReadOnly: boolean } | null {
