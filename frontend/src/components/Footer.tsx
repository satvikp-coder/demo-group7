...
export const Footer: React.FC<FooterProps> = ({ onNavigateSection, onOpenPlanner }) => {
  return (
    <footer className="bg-ink text-salt border-t border-stone/30 pt-16 pb-12 relative overflow-hidden">
      ...
      <div className="absolute inset-0 bg-stepwell-pattern opacity-10 pointer-events-none" aria-hidden="true" />
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-10 pb-12 border-b border-stone/30">
          ...
          <div className="md:col-span-2 space-y-3">
            ...
            <ul className="space-y-2 text-xs text-salt/80 font-body">
              <li><a href="#explore" className="hover:text-gold transition-colors">Solanki Stepwells</a></li>
              <li><a href="#explore" className="hover:text-gold transition-colors">White Rann & Kutch</a></li>
              <li><a href="#explore" className="hover:text-gold transition-colors">Sacred Saurashtra</a></li>
              <li><a href="#explore" className="hover:text-gold transition-colors">UNESCO Citadel Circuit</a></li>
            </ul>
          </div>
          ...
          <div className="md:col-span-2 space-y-3">
            ...
            <ul className="space-y-2 text-xs text-salt/80 font-body">
              ...
              <li><a href="#hotels" className="hover:text-gold transition-colors">Heritage Haveli Lodging</a></li>
              <li><a href="#explore" className="hover:text-gold transition-colors">Ticket Fee Ledgers</a></li>
              <li><a href="#explore" className="hover:text-gold transition-colors">Craft Village Guild Directory</a></li>
            </ul>
          </div>
          ...
          <div className="md:col-span-3 space-y-3">
            ...
            <p className="text-xs text-stone font-body leading-relaxed">
              Supporting sustainable local tourism, heritage conservation, and master craftspeople across Gujarat.
            </p>
            <div className="pt-2">
              <button
